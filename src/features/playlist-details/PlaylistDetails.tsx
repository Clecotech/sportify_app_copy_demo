...
import { BackHandler, StatusBar, StyleSheet, View, Image } from "react-native"
...
import { colors, IconAsset } from "../../common/theme"
        ...
        <>
          ...
          <View style={styles.coverContainer}>
            <DetailsCover
              ...
              name={"name"}
              imageUrl={Image.resolveAssetSource(IconAsset[4].url).uri}
          ...
          <Animated.ScrollView
            ...
            <ListOfTracks
              playlistDetails={[
                { name: "name1", artistName: "Artist 1" },
                { name: "name2", artistName: "Artist 2" },
                { name: "name3", artistName: "Artist 3" },
              ]}
              showDownload
            />
            {/* )} */}
